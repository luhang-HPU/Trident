...
namespace apsi {
    namespace sender {
        ...
        using CiphertextPowers = std::vector<poseidon::Ciphertext>;
        ...
        */
        ...
        private:
            ...
            */
            static void ComputePowers(const std::shared_ptr<SenderDB> &sender_db,
                                      const CryptoContext &crypto_context,
                                      std::vector<std::vector<poseidon::Ciphertext>> &powers,
                                      const PowersDag &pd, std::uint32_t bundle_idx,
                                      poseidon::MemoryPoolHandle &pool);
            ...
            */
            static void ProcessBinBundleCache(
                ...
                poseidon::compr_mode_type compr_mode,
                poseidon::MemoryPoolHandle &pool);
        }; // class Sender
    }      // namespace sender
} // namespace apsi
