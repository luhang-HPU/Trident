...
namespace apsi {
    namespace sender {
        ...
        */
        ...
        /**
        A bunch of polynomials represented using a sequence of batched POSEIDON Plaintexts.
        ...
        */
        struct BatchedPlaintextPolyn {
            ...
            */
            poseidon::Ciphertext eval(
                const std::vector<poseidon::Ciphertext> &ciphertext_powers,
            ...
            */
            poseidon::Ciphertext eval_patstock(
        ...
        struct BinBundleCache {
            ...
            */
            ...
            /**
            Cached poseidon::Plaintext representation of the "matching" polynomial of this BinBundle.
            */
            BatchedPlaintextPolyn batched_matching_polyn;

            /**
            Cached poseidon::Plaintext representation of the interpolation polynomial of this BinBundle.
        ...
        */
        ...
        private:
            ...
            */
            ...
            /**
            Indicates whether POSEIDON plaintexts are compressed in memory.
            */
            bool compressed_;
            ...
            */
            const poseidon::Modulus &field_mod() const;
            ...
            */
            ...
            /**
            Batches this BinBundle's polynomials into POSEIDON Plaintexts. Resulting values are stored
            in cache_.
            */
