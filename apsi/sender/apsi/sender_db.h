        ...
        */
        ...
        public:
            ...
            */
            ...
            Creates a new SenderDB.
            */
            SenderDB(PSIParams params, oprf::OPRFKey oprf_key, std::size_t label_byte_count = 0,
            ...
            */
            ...
            /**
            Returns a reference to the PoseidonContext for this SenderDB.
            */
            std::shared_ptr<poseidon::PoseidonContext> get_context() const
            {
                return crypto_context_.poseidon_context();
            }
            ...
            */
            poseidon::util::ReaderLock get_reader_lock() const
            {
        ...
        private:
            ...
            poseidon::util::WriterLock get_writer_lock()
            {
            ...
            */
            ...
            /**
            The PSI parameters define the POSEIDON parameters, base field, item size, table size, etc.
            */
            PSIParams params_;
            ...
            */
            mutable poseidon::util::ReaderWriterLocker db_lock_;
