    ...
    namespace sender {
                ...
                const PSIParams &params)
            {
                ...
                for (auto it = begin; it != end; it++) {
                    ...
                    AlgItemLabel alg_item_label = algebraize_item_label(
                        item, label, item_bit_count, params.poseidon_params().plain_modulus());
            ...
            */
                ...
                const PSIParams &params)
            {
                ...
                for (auto it = begin; it != end; it++) {
                    ...
                    // Serialize the data into field elements
                    AlgItem alg_item =
                        algebraize_item(item, item_bit_count, params.poseidon_params().plain_modulus());
        ...
        Label SenderDB::get_label(const Item &item) const
        {
            ...
            EncryptedLabel encrypted_label = dealgebraize_label(
                ...
                params_.poseidon_params().plain_modulus());
