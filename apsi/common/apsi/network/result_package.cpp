...
namespace apsi {
    namespace network {
        ...
        */
        size_t ResultPackage::load(istream &in, shared_ptr<PoseidonContext> context)
        {
        ...
        PlainResultPackage ResultPackage::extract(const CryptoContext &crypto_context)
        {
            ...
            Ciphertext psi_result_ct = psi_result.extract(crypto_context.poseidon_context());
            ...
            for (auto &ct : label_result) {
                Ciphertext label_result_ct = ct.extract(crypto_context.poseidon_context());
