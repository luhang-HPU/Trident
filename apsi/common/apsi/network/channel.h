...
public:
    ...
    */
    ...
    require a valid poseidon::PoseidonContext to be provided. For operations of type sop_parms and
    sop_oprf the context can be set as nullptr. The function returns nullptr on failure.
    */
    virtual std::unique_ptr<SenderOperation>
    receive_operation(std::shared_ptr<poseidon::PoseidonContext> context,
    ...
    */
    ...
    failure.
    */
    virtual std::unique_ptr<SenderOperationResponse>
    receive_response(SenderOperationType expected = SenderOperationType::sop_unknown) = 0;
    ...
    */
    ...
    /**
    Receive a ResultPackage from a sender. A valid poseidon::PoseidonContext must be provided. The
    function returns nullptr on failure.
    */
    virtual std::unique_ptr<ResultPackage>
    receive_result(std::shared_ptr<poseidon::PoseidonContext> context) = 0;
