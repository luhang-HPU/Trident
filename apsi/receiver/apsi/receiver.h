        ...
        */
        ...
        public:
            ...
            */
            ...
            /**
            Returns a reference to the PoseidonContext for this Receiver.
            */
            ...
            */
            ...
            create_query(const std::vector<HashedItem> &items);
        ...
        private:
            ...
            */
            ...
            PoseidonObject<poseidon::RelinKeys> relin_keys_;

            std::unique_ptr<poseidon::KeyGenerator> key_gen_;
        }; // class Receiver
    }      // namespace receiver
} // namespace apsi
