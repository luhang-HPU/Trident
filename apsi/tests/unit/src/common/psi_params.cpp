...
namespace APSITests {
    TEST(PSIParamsTest, Constructor1)
    {
        ...
        size_t pmd = 4096;
        PSIParams::PoseidonParams poseidon_params(pmd);
        // poseidon_params.set_poly_modulus_degree(pmd);
        // poseidon_params.set_coeff_modulus(CoeffModulus::Create(pmd, { 40, 40 }));
        poseidon_params.set_plain_modulus(65537);

        // All good parameters
        ASSERT_NO_THROW(PSIParams psi_params(item_params, table_params, query_params, poseidon_params));

        // Too short item (4 * 16 == 64 < 80)
        item_params.felts_per_item = 4;
        ASSERT_THROW(
            PSIParams psi_params(item_params, table_params, query_params, poseidon_params),
            invalid_argument);
        ...
        // POSEIDON ciphertext, so this table will be too small to fill even one POSEIDON ciphertext.
    ...
    TEST(PSIParamsTest, Constructor2)
    {
        ...
        ASSERT_NO_THROW(
            psi_params =
                make_unique<PSIParams>(item_params, table_params, query_params, poseidon_params));
    ...
    TEST(PSIParamsTest, SaveLoadPSIParams)
    {
        ...
        PSIParams::PoseidonParams poseidon_params(pmd);
        // poseidon_params.set_poly_modulus_degree(pmd);
        // poseidon_params.set_coeff_modulus(CoeffModulus::Create(pmd, { 40, 50, 40 }));
        poseidon_params.set_plain_modulus(65537);
    ...
    TEST(PSIParamsTest, JSONLoadPSIParams)
    {
        string json =
            ...
            "    },"
            "    \"poseidon_params\": {"
            "        /* Plaintext modulus prime for Microsoft POSEIDON encryption */"
            "        \"plain_modulus\": 40961,"
            "        /* Degree of the polynomial modulus for Microsoft POSEIDON encryption */"
            "        \"poly_modulus_degree\": 4096,"
            "        /* Bit sizes for coefficient modulus primes for Microsoft POSEIDON encryption */"
        ...
        ASSERT_EQ(40961, params.poseidon_params().plain_modulus().value());
        ASSERT_EQ(4096, params.poseidon_params().degree());
        ASSERT_EQ(3, params.poseidon_params().coeff_modulus().size());
        ASSERT_EQ(49, params.poseidon_params().coeff_modulus()[0].bit_count());
        ASSERT_EQ(40, params.poseidon_params().coeff_modulus()[1].bit_count());
        ASSERT_EQ(20, params.poseidon_params().coeff_modulus()[2].bit_count());
        ...
        json =
            ...
            "    },"
            "    \"poseidon_params\": {"
            "        /* Bit size for plaintext modulus prime for Microsoft POSEIDON encryption */"
        ...
        ASSERT_EQ(24, params.poseidon_params().plain_modulus().bit_count());
        ASSERT_EQ(8192, params.poseidon_params().degree());
        ASSERT_EQ(4, params.poseidon_params().coeff_modulus().size());
        ASSERT_EQ(49, params.poseidon_params().coeff_modulus()[0].bit_count());
        ASSERT_EQ(49, params.poseidon_params().coeff_modulus()[1].bit_count());
        ASSERT_EQ(40, params.poseidon_params().coeff_modulus()[2].bit_count());
        ASSERT_EQ(20, params.poseidon_params().coeff_modulus()[3].bit_count());
    }
    ...
    TEST(PSIParamsTest, JSONMissingPOSEIDONParams)
    {
        string json =
            "{"
            "    \"table_params\": {"
