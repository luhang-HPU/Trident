...
namespace APSITests {
    TEST(SenderOperationResponseTest, SaveLoadSenderOperationResponseParms)
    {
        ...
        // poseidon_params.set_coeff_modulus(CoeffModulus::Create(pmd, { 40, 40, 40 }));
        poseidon_params.set_plain_modulus(65537);

        sopr.params = make_unique<PSIParams>(item_params, table_params, query_params, poseidon_params);
        ...
        ASSERT_EQ(sopr.params->poseidon_params(), sopr2.params->poseidon_params());
    }
